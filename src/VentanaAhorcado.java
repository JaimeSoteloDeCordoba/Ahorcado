...
public class VentanaAhorcado extends javax.swing.JFrame {
  ...
  //palabraOculta en el futuro la pondré con un random
    ...
    //este metodo recibe la letra que aparece 
    //en el botón que ga sudo pulsado
          ...
          //desocultar la letra en la pantalla
           for (int i=0; i<palabraOculta.length(); i++){
               if(palabraOculta.charAt(i)== letra.charAt(0)){
                   //si hemos llegado aqui es por la letra
    ...
    //chequeo si el boton ha sido pulsado
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, 377, 102));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(436, 100, -1, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 182, 52, 45));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 182, 52, 45));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 182, 52, 45));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 182, 52, 45));
        ...
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 182, 52, 45));
        ...
        getContentPane().add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 182, 52, 45));
        ...
        getContentPane().add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 245, 52, 45));
        ...
        getContentPane().add(jButton8, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 245, 52, 45));
        ...
        getContentPane().add(jButton9, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 245, 52, 45));
        ...
        getContentPane().add(jButton10, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 245, 52, 45));
        ...
        getContentPane().add(jButton11, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 245, 52, 45));
        ...
        getContentPane().add(jButton12, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 245, 52, 45));
        ...
        getContentPane().add(jButton13, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 308, 52, 45));
        ...
        getContentPane().add(jButton14, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 308, 52, 45));
        ...
        getContentPane().add(jButton15, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 308, 52, 45));
        ...
        getContentPane().add(jButton16, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 308, 52, 45));
        ...
        getContentPane().add(jButton17, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 308, 52, 45));
        ...
        getContentPane().add(jButton18, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 308, 52, 45));
        ...
        getContentPane().add(jButton19, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 371, 52, 45));
        ...
        getContentPane().add(jButton20, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 371, 52, 45));
        ...
        getContentPane().add(jButton21, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 371, 52, 45));
        ...
        getContentPane().add(jButton22, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 371, 52, 45));
        ...
        getContentPane().add(jButton23, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 371, 52, 45));
        ...
        getContentPane().add(jButton24, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 371, 52, 45));
        ...
        getContentPane().add(jButton26, new org.netbeans.lib.awtextra.AbsoluteConstraints(112, 434, 52, 45));
        ...
        getContentPane().add(jButton27, new org.netbeans.lib.awtextra.AbsoluteConstraints(182, 434, 52, 45));
        ...
        getContentPane().add(jButton28, new org.netbeans.lib.awtextra.AbsoluteConstraints(252, 434, 52, 45));

        jLabel2.setText("0");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 30, 80, 40));
